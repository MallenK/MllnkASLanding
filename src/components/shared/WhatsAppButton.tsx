...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className={cn(
        "group fixed right-3 z-40 flex h-10 w-10 items-center justify-center rounded-full bg-[#25D366] ring-2 ring-brand-black transition-[transform,bottom] hover:scale-105 sm:right-5 sm:h-12 sm:w-12",
